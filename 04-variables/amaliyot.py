...
# 2-savol yechimi.
xabar = "Birinchi xabar"
print(xabar)

xabar = "Ikkinchi xabar"
print(xabar)


# 3-savol yechimi.
# class = "Bu class nomli o'zgaruvchi"
# print(class)
# Bu kod xatolik beradi, chunki 'class' nomli maxsus kalit so'z mavjud.

# 4-savol yechimi.
radius = 5
pi = 3.14159
aylana_yuzi = pi * radius**2
print("Radiusi" , radius, "ga teng aylananing yuzi=", aylana_yuzi) # Radiusi 5 ga teng aylananing yuzi= 78.53975